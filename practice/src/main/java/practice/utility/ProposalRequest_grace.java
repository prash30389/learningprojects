...
public class ProposalRequest_grace extends TestBase {

	static String projectPath, pno;
	static String jsonfile;

	public static String graceCode() throws Exception {
		init();
		...
		policyInfo.replace("policyNumber", "ALI0QARE" + Integer.toString(aNumber1));
		...
		Date dateBefore = DateUtils.addDays(new Date(), -38);
		Date dateBefore1 = DateUtils.addDays(new Date(), -38);
	...
	//====Grace Policy For Claim============	
	public static String graceClaimPolicy() throws Exception {
		init();
		projectPath = System.getProperty("user.dir");
		jsonfile = projectPath + "/ProposalRequest.json";
		...
		policyInfo.replace("policyNumber", "ALI0QARE" + Integer.toString(aNumber1)+2);
